...
public class CapNhatThongTinGiaoVuFrame extends JDialog implements ActionListener {
	...
	CapNhatThongTinGiaoVuFrame(JFrame parent, GiaoVu gv) {
		super(parent, true);
		_parent = parent;
