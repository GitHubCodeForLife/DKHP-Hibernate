...
public class ThemMonHocFrame extends JDialog implements ActionListener {
	...
	ThemMonHocFrame(JFrame parent, GiaoVu gv) {
		super(parent, true);
		_parent = parent;
		_gv = GiaoVuDao.layThongTinGiaoVu(gv.getTKGV());
		Container con = this.getContentPane();
		// Title
		JPanel titlePn = createTitle("         THÊM TÀI MÔN HỌC         ");
		// Content
