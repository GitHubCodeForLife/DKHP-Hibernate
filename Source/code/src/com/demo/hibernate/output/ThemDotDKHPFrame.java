...
//		labelForSlang.setForeground(new Color(127, 127, 127, 50));
		...
		model.setValue(convertToDateViaSqlDate(HocKiDao.layHocKiHienTai().tgBD()));
...
//		labelForSlang.setForeground(new Color(127, 127, 127, 50));
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == quayLaiBtn) {
			...
			if (tgbd.before(convertToDateViaSqlDate(hocKi.tgBD()))
					|| tgkt.after(convertToDateViaSqlDate(hocKi.getTgKT()))) {
